import 'package:fintech_dashboard_clone/data/fake_date.dart';
import 'package:flutter/material.dart';
import 'package:flutter/rendering.dart';

class DataTableAdmin extends StatefulWidget {
  const DataTableAdmin({Key? key}) : super(key: key);

  @override
  State<DataTableAdmin> createState() => _DataTableAdminState();
}

class _DataTableAdminState extends State<DataTableAdmin> {
  @override
